---
name: video-use
description: Edit any video by conversation. Transcribe, cut, generate overlay animations, burn subtitles — for talking heads. No presets, no menus. Ask questions, execute, iterate, persist. Production-correctness rules are hard; everything else is artistic freedom.
---
